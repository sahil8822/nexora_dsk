...
/// Generated class from Pigeon that represents data sent in messages.
struct NexoraAiResult: Hashable {
  var label: String? = nil
  var confidence: Double? = nil
  var boundingBox: [String?: Any?]? = nil
  var recognizedText: String? = nil


  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> NexoraAiResult? {
    let label: String? = nilOrValue(pigeonVar_list[0])
    let confidence: Double? = nilOrValue(pigeonVar_list[1])
    let boundingBox: [String?: Any?]? = nilOrValue(pigeonVar_list[2])
    let recognizedText: String? = nilOrValue(pigeonVar_list[3])
  ...
  static func == (lhs: NexoraAiResult, rhs: NexoraAiResult) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHardwareApi(lhs.label, rhs.label) && deepEqualsHardwareApi(lhs.confidence, rhs.confidence) && deepEqualsHardwareApi(lhs.boundingBox, rhs.boundingBox) && deepEqualsHardwareApi(lhs.recognizedText, rhs.recognizedText)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("NexoraAiResult")
    deepHashHardwareApi(value: label, hasher: &hasher)
    deepHashHardwareApi(value: confidence, hasher: &hasher)
    deepHashHardwareApi(value: boundingBox, hasher: &hasher)
    deepHashHardwareApi(value: recognizedText, hasher: &hasher)
  }
}
...
private class HardwareApiPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 148:
      return NexoraAiResult.fromList(self.readValue() as! [Any?])
    default:
...
private class HardwareApiPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? NexoraCameraOptions {
      ...
      super.writeByte(147)
      super.writeValue(value.toList())
    } else if let value = value as? NexoraAiResult {
      super.writeByte(148)
      super.writeValue(value.toList())
    } else {
...
protocol SystemApi {
  ...
  func startBackgroundSync(intervalMinutes: Int64, completion: @escaping (Result<Bool, Error>) -> Void)
  func stopBackgroundSync(completion: @escaping (Result<Bool, Error>) -> Void)
}
...
class SystemApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: SystemApi?, messageChannelSuffix: String = "") {
    ...
    let startBackgroundSyncChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.nexora_sdk_platform_interface.SystemApi.startBackgroundSync\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      startBackgroundSyncChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let intervalMinutesArg = args[0] as! Int64
        api.startBackgroundSync(intervalMinutes: intervalMinutesArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      startBackgroundSyncChannel.setMessageHandler(nil)
    }
    let stopBackgroundSyncChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.nexora_sdk_platform_interface.SystemApi.stopBackgroundSync\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      stopBackgroundSyncChannel.setMessageHandler { _, reply in
        api.stopBackgroundSync { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      stopBackgroundSyncChannel.setMessageHandler(nil)
    }
  }
}
/// Generated protocol from Pigeon that represents a handler of messages from Flutter.
...
/// Generated protocol from Pigeon that represents a handler of messages from Flutter.
protocol AiApi {
  func processImageWithFaceDetection(imageBytes: FlutterStandardTypedData, completion: @escaping (Result<[NexoraAiResult?], Error>) -> Void)
  func processImageWithBarcodeScanning(imageBytes: FlutterStandardTypedData, completion: @escaping (Result<[NexoraAiResult?], Error>) -> Void)
  func processImageWithTextRecognition(imageBytes: FlutterStandardTypedData, completion: @escaping (Result<[NexoraAiResult?], Error>) -> Void)
  func runCustomModelInference(modelPath: String, inputBytes: FlutterStandardTypedData, completion: @escaping (Result<[String?: Any?]?, Error>) -> Void)
}
...
class AiApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: AiApi?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let processImageWithFaceDetectionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.nexora_sdk_platform_interface.AiApi.processImageWithFaceDetection\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      processImageWithFaceDetectionChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let imageBytesArg = args[0] as! FlutterStandardTypedData
        api.processImageWithFaceDetection(imageBytes: imageBytesArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      processImageWithFaceDetectionChannel.setMessageHandler(nil)
    }
    let processImageWithBarcodeScanningChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.nexora_sdk_platform_interface.AiApi.processImageWithBarcodeScanning\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      processImageWithBarcodeScanningChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let imageBytesArg = args[0] as! FlutterStandardTypedData
        api.processImageWithBarcodeScanning(imageBytes: imageBytesArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      processImageWithBarcodeScanningChannel.setMessageHandler(nil)
    }
    let processImageWithTextRecognitionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.nexora_sdk_platform_interface.AiApi.processImageWithTextRecognition\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      processImageWithTextRecognitionChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let imageBytesArg = args[0] as! FlutterStandardTypedData
        api.processImageWithTextRecognition(imageBytes: imageBytesArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      processImageWithTextRecognitionChannel.setMessageHandler(nil)
    }
    let runCustomModelInferenceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.nexora_sdk_platform_interface.AiApi.runCustomModelInference\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      runCustomModelInferenceChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let modelPathArg = args[0] as! String
        let inputBytesArg = args[1] as! FlutterStandardTypedData
        api.runCustomModelInference(modelPath: modelPathArg, inputBytes: inputBytesArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      runCustomModelInferenceChannel.setMessageHandler(nil)
    }
  }
}
